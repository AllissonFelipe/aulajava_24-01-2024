        ...
        try {
            ...
            while (rsSqlReceitas.next()) {
                ...
                if (receitaDisponivel == true) {
                    InterfacePadoka.resp += "[" + numReceita + "] - " + nomeReceita + " - disponível.\n";
                    //System.out.println("[" + numReceita + "] - " + nomeReceita + " - disponível.");
                } else {
                    InterfacePadoka.respIndisponivel += "[" + numReceita + "] - " + nomeReceita + " - indisponível.";
